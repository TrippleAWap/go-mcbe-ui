...
func (p *Panel) Bindings(bindings ...schema.Bind) *Panel { p.c.Bindings = append(p.c.Bindings, bindings...); return p }
func (p *Panel) Animations(anims ...schema.Anim) *Panel  { p.c.Anims = append(p.c.Anims, anims...); return p }
func (p *Panel) Raw(key string, val interface{}) *Panel {
	if p.c.Raw == nil { p.c.Raw = make(map[string]json.RawMessage) }
	raw, err := json.Marshal(val)
...
func (l *Label) Bindings(bindings ...schema.Bind) *Label { l.c.Bindings = append(l.c.Bindings, bindings...); return l }
func (l *Label) Animations(anims ...schema.Anim) *Label  { l.c.Anims = append(l.c.Anims, anims...); return l }
func (l *Label) Raw(key string, val interface{}) *Label {
	if l.c.Raw == nil { l.c.Raw = make(map[string]json.RawMessage) }
	raw, err := json.Marshal(val)
	if err != nil { panic(err) }
	l.c.Raw[key] = raw
	return l
...
func (i *Image) UVSize(w, h float64) *Image             { v := schema.Vector2{X: w, Y: h}; i.c.UVSize = &v; return i }
...
func (i *Image) Bindings(bindings ...schema.Bind) *Image     { i.c.Bindings = append(i.c.Bindings, bindings...); return i }
func (i *Image) Animations(anims ...schema.Anim) *Image      { i.c.Anims = append(i.c.Anims, anims...); return i }
func (i *Image) Raw(key string, val interface{}) *Image {
	if i.c.Raw == nil { i.c.Raw = make(map[string]json.RawMessage) }
	raw, err := json.Marshal(val)
	if err != nil { panic(err) }
	i.c.Raw[key] = raw
	return i
...
func (b *Button) Bindings(bindings ...schema.Bind) *Button { b.c.Bindings = append(b.c.Bindings, bindings...); return b }
func (b *Button) Animations(anims ...schema.Anim) *Button  { b.c.Anims = append(b.c.Anims, anims...); return b }
func (b *Button) Raw(key string, val interface{}) *Button {
	if b.c.Raw == nil { b.c.Raw = make(map[string]json.RawMessage) }
	raw, err := json.Marshal(val)
	if err != nil { panic(err) }
	b.c.Raw[key] = raw
	return b
...
func (s *StackPanel) Anchor(a schema.Anchor) *StackPanel  { s.c.AnchorFrom = a; s.c.AnchorTo = a; return s }
...
func (s *StackPanel) AddControl(id string) *StackPanel    { s.c.Controls = append(s.c.Controls, id); return s }
func (s *StackPanel) Horizontal() *StackPanel { s.c.Orientation = schema.OrientationHorizontal; return s }
...
func (s *StackPanel) Bindings(bindings ...schema.Bind) *StackPanel { s.c.Bindings = append(s.c.Bindings, bindings...); return s }
func (s *StackPanel) Animations(anims ...schema.Anim) *StackPanel  { s.c.Anims = append(s.c.Anims, anims...); return s }
func (s *StackPanel) Raw(key string, val interface{}) *StackPanel {
	if s.c.Raw == nil { s.c.Raw = make(map[string]json.RawMessage) }
	raw, err := json.Marshal(val)
	if err != nil { panic(err) }
	s.c.Raw[key] = raw
	return s
...
func (g *Grid) Bindings(bindings ...schema.Bind) *Grid { g.c.Bindings = append(g.c.Bindings, bindings...); return g }
func (g *Grid) Animations(anims ...schema.Anim) *Grid  { g.c.Anims = append(g.c.Anims, anims...); return g }
func (g *Grid) Raw(key string, val interface{}) *Grid {
	if g.c.Raw == nil { g.c.Raw = make(map[string]json.RawMessage) }
	raw, err := json.Marshal(val)
	if err != nil { panic(err) }
	g.c.Raw[key] = raw
	return g
...
func (s *Screen) Bindings(bindings ...schema.Bind) *Screen { s.c.Bindings = append(s.c.Bindings, bindings...); return s }
func (s *Screen) Animations(anims ...schema.Anim) *Screen  { s.c.Anims = append(s.c.Anims, anims...); return s }
...
func (s *ScrollView) Anchor(a schema.Anchor) *ScrollView  { s.c.AnchorFrom = a; s.c.AnchorTo = a; return s }
...
func (s *ScrollView) ScrollbarAlwaysVisible() *ScrollView   { s.c.ScrollbarAlwaysVisible = true; return s }
...
func (cp *CollectionPanel) Anchor(a schema.Anchor) *CollectionPanel { cp.c.AnchorFrom = a; cp.c.AnchorTo = a; return cp }
func (cp *CollectionPanel) Pos(v schema.Relative) *CollectionPanel { cp.c.Offset = schema.PtrRel(v); return cp }
func (cp *CollectionPanel) Size(v schema.Relative) *CollectionPanel { cp.c.Size = schema.PtrRel(v); return cp }
func (cp *CollectionPanel) Collection(name string) *CollectionPanel { cp.c.CollectionName = name; return cp }
...
func (sw *SelectionWheel) Anchor(a schema.Anchor) *SelectionWheel { sw.c.AnchorFrom = a; sw.c.AnchorTo = a; return sw }
func (sw *SelectionWheel) Pos(v schema.Relative) *SelectionWheel { sw.c.Offset = schema.PtrRel(v); return sw }
func (sw *SelectionWheel) Size(v schema.Relative) *SelectionWheel { sw.c.Size = schema.PtrRel(v); return sw }
